...
module.exports.deleteInstance = function(req, res) {
    ...
    // console.log("Reseive id to delete. call instnce.getVmId.", idVmMongo);
    Instance.getVmId({ _id: idVmMongo }, res, function(result, res) {
        // console.log("Receive vmid result", result);
        if (result.details.status !== 'stopped') {
            return res.json({
                status: "ERROR",
                stdout: "This Instance not Stopped. Stop and remove then."
            });
        } else {
            ...
            vm.action('delete', function(err, data) {
                ...
                // console.log("Call instance delete.", idVmMongo);
...
module.exports.statusInstance = function(req, res) {
    var idVmMongo = req.params.id;
    Instance.getVmId({ _id: idVmMongo }, res, function(result, res) {
        // console.log("statusInstance", result);
