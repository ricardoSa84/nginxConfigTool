...
ServerHost.prototype.removeServerHost = function(params, nextInsert, res) {
    ...
    if (paramsKey[0] === "localhost") {
        self.removeServerHostSimple(params, nextInsert, "local", res);
    } else {
        Instance.getVmId({ _id: sKey[0] }, res, function(result, res) {
...
ServerHost.prototype.removeServerHostSimple = function(params, nextInsert, local, res) {
    var self = this;
