...
module.exports.reloadnginx = function(req, res) {
    ...
    if (instance === "localhost") {
        ...
        console.log("1", instanceSelected);
        setTimeout(function() {
        console.log("2", instanceSelected);
            Instance.getVmId({ _id: instanceSelected }, res, function(result, res) {
        console.log("3", instanceSelected);
