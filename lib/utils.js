...
function getStaticInfo(obj,serverName,port) {
    ...
    if (obj.staicCacheExtentions != undefined) {
        ...
        toReturn.locationName = (obj.staicCachePath.initLocPath == "" ? '':obj.staicCachePath.initLocPath + '/') + '~^/(' + obj.staicCachePath.locpath + ')/';
...
module.exports = {
    ...
    createNewInstance: function(json) {
        ...
        var one = new OpenNebula('oneadmin:opennebula', 'http://172.16.100.1:2633/RPC2');
