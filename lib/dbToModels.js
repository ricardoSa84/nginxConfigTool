...
module.exports.getOptionsToPlace = function(req, res) {
    OptionSelect.getOptionsFromPlace({ "text": req.params.place }, res);
};

module.exports.InsertAllOptionSelect = function(req, res) {
    OptionSelect.InsertOptionSelect({
        text: "Location",
        options: ["proxy_pass", "proxy_redirect", "proxy_set_header", "proxy_cache", "proxy_cache_valid", "add_header", "proxy_cache_key"]
    }, res);
};
