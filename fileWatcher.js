...
function parseLine(line) {
  ...
  console.log('async certo? :P :', parsed);
  return parsed;
};

module.exports = {
  startWatch: function(path) {
      var watchPath = path == '' || path == undefined? '/var/log/nginx/access.log': path;
      var tail = new Tail(path);
      var result = tail.on('line',parseLine);
      console.log('inlineRes', result);
  }
};
